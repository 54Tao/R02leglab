...
from legged_lab.envs.r02_2.r02_2_config import (
    R02_2FlatAgentCfg,
    R02_2FlatEnvCfg,
    R02_2RoughAgentCfg,
    R02_2RoughEnvCfg,
...
task_registry.register("r02_2_flat", BaseEnv, R02_2FlatEnvCfg(), R02_2FlatAgentCfg())
task_registry.register("r02_2_rough", BaseEnv, R02_2RoughEnvCfg(), R02_2RoughAgentCfg())
