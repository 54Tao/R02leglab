...
class CommandRangesCfg:
    lin_vel_x: tuple = (0.5, 1.5)  # 强制前进
    lin_vel_y: tuple = (-0.2, 0.2)  # 小幅侧向
    ang_vel_z: tuple = (-0.8, 0.8)  # 小幅转向
...
class CommandsCfg:
    ...
    rel_standing_envs: float = 0.1  # 10%站立
    rel_heading_envs: float = 0.0   # 不用heading
    heading_command: bool = False    # 关闭heading
